    ...
    <div className="min-h-screen bg-gray-50 px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
      <div className="mx-auto max-w-max">
        <main className="sm:flex">
          <p className="text-4xl font-bold tracking-tight text-coral sm:text-5xl">404</p>
          <div className="sm:ml-6">
            ...
            <div className="mt-8 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
              ...
              <Link
                href="/support"
                className="inline-flex items-center rounded-md border border-coral px-3 py-2 text-sm font-semibold text-coral shadow-sm hover:bg-gray-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-coral"
              >
                Contact support
              </Link>
            </div>
