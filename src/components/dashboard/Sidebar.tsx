...
const navigation = [
  ...
  { name: 'Resources', href: '/dashboard/resources', icon: BuildingLibraryIcon },
    ...
    <div className={clsx(
          ...
          {navigation.map((item) => {
            ...
            return (
              ...
              >
                <item.icon
                  className={clsx(
                    isActive ? 'text-coral-600' : 'text-gray-400 group-hover:text-gray-500',
      ...
      <div className="flex-shrink-0 border-t border-gray-200 p-4">
        <div className="w-full">
          <UserAvatarMenu user={user} profile={profile} isCollapsed={isCollapsed} />
        </div>
      </div>
    </div>
  );
