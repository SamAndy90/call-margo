-- Create brand_data table if it doesn't exist
...
-- Create audience_profiles table if it doesn't exist
...
-- Create voice_of_customer table if it doesn't exist
...
-- Create audience_notes table if it doesn't exist
...
CREATE POLICY "Users can view their own brand data" ON brand_data
    FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can create their own brand data" ON brand_data
    FOR INSERT WITH CHECK (auth.uid() = user_id);
CREATE POLICY "Users can update their own brand data" ON brand_data
    FOR UPDATE USING (auth.uid() = user_id);
CREATE POLICY "Users can delete their own brand data" ON brand_data
...
CREATE POLICY "Users can view their own competitors" ON competitors
    FOR SELECT USING (auth.uid() = user_id);
CREATE POLICY "Users can create their own competitors" ON competitors
    FOR INSERT WITH CHECK (auth.uid() = user_id);
